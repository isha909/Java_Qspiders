public class Method5 {
  ...
  public static void power4(int a){
    int b = a*a*a*a;
    System.out.println(b);
  }
  ...
  public static void stud_details(int roll , String name, String dob , String course , char sec , char blood_grp , String mail_id , char gender , int year , long mob_no){
  ...
  public static void num2(int m , int n){
    for(int i = m; i <= n ; i++){
      System.out.println(i);
    }
  }
  ...
  public static void div3(int m , int n){
    for(int i = m; i <= n ; i++){
      if(i%3==0){
        System.out.println(i);
      }
